        	...
        	<form action="#" id="form" class="form-horizontal">
				...
				<hr>
			  	<div class="row">
                    ...
                    <div class="col-md-8"><b style="font-size:14px"><?php echo $perimeter->mpm_name; ?></b></div>
              	</div>
              	<div class="row">
					<div class="col-md-4"><p style="font-size:14px">Nama Perusahaan</p></div>
                    <div class="col-md-8"><b style="font-size:14px"><?php echo $perimeter->mc_name; ?></b></div>
              	</div>
				<div class="row">
					<div class="col-md-4"><p style="font-size:14px">Alamat</p></div>
                    <div class="col-md-8"><b style="font-size:14px"><?php echo $perimeter->mpm_alamat; ?></b></div>
              	</div>
				<div class="row">
					<div class="col-md-4"><p style="font-size:14px">Lantai<span style="color:red">*</span></p></div>
                    <div class="col-md-4">
                       <select name="lantai" id="lantai" data-live-search="true"
						class="form-control form-control-sm selectpicker" 
						data-style="btn-white btn-default">
 						<?php foreach ($perimeter_lantai as $pl){ ?>
                        	<option value="<?php echo $pl->mpml_id;?>"><?php echo $pl->mpml_name;?></option>
                       	<?php } ?>
                        </select>
                    </div>
              	</div>
