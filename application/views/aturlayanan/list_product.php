              ...
              <div class ="row">
                ...
                <div class ="col-12 col-md-6 col-lg-8">
                  ...
                  <div class="col-6 col-sm-12">
                    ...
                    <button type="button" class="btn btn-lg btn-primary" id="btnPengajuan" onclick="add_pengajuan(<?php echo $itemproduct->mlp_id; ?>)" >Daftar</button>
                    <?php } ?>
                    <?php //if ( $group==2  && $com==$itemproduct->mlp_mc_id ) {?>
                    <button type="button" class="btn btn-lg btn-primary" id="btnEditProduct"  onclick="edit_product(<?php echo $itemproduct->mlp_id; ?>)" ><i class ="fa fa-pencil"></i>  View</button>
                    <?php// } ?>
                  </div>
                </div>
              </div>
...
function edit_product(id_product) {
    ...
    // console.log('inid 1');
    $.ajax({
        url : "<?php echo site_url('aturlayanan/ajax_edit_product')?>/"+id_product,
        type: "GET",
        dataType: "JSON",
        success: function(data) {
            ...
            $('[name="modal_syarat"]').val(data.mlp_text_syarat_ketentuan);

            if(data.mlp_active=="t"){
                $(`.check1`).prop("checked", true);
                $('.check1').bootstrapToggle('on')
            }else{
                $(`.check1`).prop("checked", false);
                $('.check1').bootstrapToggle('off')
            }
            ...
            if(data.mlp_file_syarat_ketentuan) {
                var f = "<a target='_blank' href='<?php echo base_url('/uploads/product/')?>/"+data.mlp_file_syarat_ketentuan+"'>"+data.mlp_file_syarat_ketentuan+"</a>";
                $('#modal_p_file_txt').html(f); // label photo upload
            } else {
...
function save_product() {
    ...
    if(save_method == 'update_product') {
      console.log('ini 1');
    	url = "<?php echo site_url('aturlayanan/ajax_update_product')?>";
    }
    console.log('2');
    ...
    <div class="modal-body form">
        <form action="#" id="form_modal" class="form-horizontal">
            ...
            <div class="form-body">
                ...
                <div class="form-group">
                  <input id="modal_ceklis" name="modal_ceklis" placeholder="Checklist" class="form-control col-sm-2" type="checkbox"  onchange="ceklis()"  >
                  <label class="col-sm-12 " for="modal_ceklis" style="font-size:11px;">Kami sudah membaca dan menyetujui syarat dan ketentuan
...
<div class="modal-content">
    ...
    <div class="modal-body form">
        <form action="#" id="form_modal_edit" class="form-horizontal">
            ...
            <div class="form-body">
                 <div class="form-group">
                      <label class="control-label col-sm-12">LAYANAN AKTIF &nbsp; <div class="pull-right">
                    <input type="checkbox" name="check1" class="check1" data-toggle="toggle"></div></label>
                      <!-- <div class="col-sm-12"> -->
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <textarea id="modal_p_deskripsi" row="4" style="height:100px;" form="form_modal_edit" name="modal_p_deskripsi" placeholder="Deskripsi" class="form-control" required></textarea>
                        <span class="help-block"></span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-6" id="label-photo_syarat">File Syarat dan Ketentuan<span style="color:red">*</span></label>
                    <div class="col-md-12">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-12">Tulis Syarat dan Ketentuan disini</label>
                    <div class="col-sm-12">
                        <textarea id="modal_syarat" row="4" style="height:100px;" form="form_modal_edit" name="modal_syarat" placeholder="Syarat dan Ketentuan Tambahan" class="form-control" required></textarea>
                        <span class="help-block"></span>
                    </div>
                </div>
  			</div>
