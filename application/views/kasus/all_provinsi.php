	...
	<div class="col-8 col-md-8 col-lg-8">
		<div class="card">
              <div class="card-body">
                ...
                <div class="form-group">
                    <div class="">
                       <table id="tbl_byprovinsi" class="display table table-bordered" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>No. </th>
                                    <th>Provinsi</th>
...
$(document).ready(function() {
    var str_table ="<?php echo base_url().'dashkasus/ajax_provinsi_all/'.$msk_id; ?>";
    ...
    $('title').html('Kasus By Provinsi');
    tbl_byprovinsi = $('#tbl_byprovinsi').DataTable({
    	"destroy": true,
        "responsive": true,
        "processing": true,
        "serverSide": false,
...
function refresh_list(){
	...
	var kasus  = $('#kasus').val();
	var str_table ="<?php echo base_url().'dashkasus/ajax_provinsi_all/'; ?>"+kasus;
