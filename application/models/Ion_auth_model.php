...
// 		$this->where($this->tables['users'].'.id', $id);
	...
	public function add_to_group($group_ids, $user_id=false)
	{
		...
		{
		    if ($this->db->insert($this->tables['users_groups'], array($this->join['users'] => (int)$user_id, $this->join['groups'] => (int)$group_id)))
			{
	...
	**/
	...
	public function cek_lastlogin_byusername($user){
